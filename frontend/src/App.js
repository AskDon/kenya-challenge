...
import TeammateSignupPage from './pages/TeammatSignupPage';
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/supporter-dashboard" element={<PrivateRoute><SupporterDashboard /></PrivateRoute>} />
      <Route path="/fundraise/:userId" element={<FundraisingPage />} />
      <Route path="/leaderboard" element={<LeaderboardPage />} />
      <Route path="/admin" element={<AdminRoute><AdminPage /></AdminRoute>} />
      <Route path="/profile" element={<PrivateRoute><ProfilePage /></PrivateRoute>} />
      <Route path="/teams/join/:inviteCode" element={<TeammateSignupPage />} />
